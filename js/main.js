...
window.onload = function () {
	...
	AssessmentActions.receiveData({
		...
		collaborators: [
			{
			  "id": 2,
			  "cols": ["Петров Михаил Валерьевич", 2, 2, "", 1, 66, 20],
			  "edit": [3],
			  "children": [
			    {
			      "id": 4444,
			      "cols": ["Иванов Иван Иванович", 2, 2, 1, 1, 50, 20],
			      "edit": [3]
			    },
			    {
			      "id": 5,
		    ...
		    {
		      "id": 6,
		      "cols": ["Иванов Александр Алексеевич", 2, 2, 2, 1, 66, 20],
		      "edit": [3],
		      "children": [
		        {
		          "id": 7,
		    ...
		    {
		      "id": 9,
		      "cols": ["Степанов Артем Васильевич", 2, 2, 3, 1, 33, 60],
		      "edit": [3],
		      "children": [
		        {
		          "id": 10,
		    ...
		    {
		      "id": 19,
		      "cols": ["Матвеев Алексей Васильевич", 2, 2, 3, 1, 33, 60],
		      "edit": [3],
		      "children": [
		        {
		          "id": 110,
		    ...
		    {
		      "id": 29,
		      "cols": ["Стрекаловский Андрей Васильевич", 2, 2, 5, 1, 33, 60],
		      "edit": [3],
		      "children": [
		        {
		          "id": 210,

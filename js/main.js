...
window.onload = function () {
	...
	AssessmentActions.receiveData([
			{
			  "id": 2,
			  "cols": ["Петров Михаил Валерьевич", 1, 2, 3, "28%", "5%"],
			  "edit": [3],
			  "children": [
			    {
			      "id": 4,
			      "cols": ["Иванов Иван Иванович", 1, 2, 3, "28%", "5%"],
			      "edit": []
			    },
			    {
			      "id": 5,
			      "cols": ["Александров Александр Александрович", 1, 2, 3, "28%", "5%"],
			      "edit": []
			    },
			    {
			      "id": 44,
			    ...
			    {
			      "id": 55,
			      "cols": ["Беловоденко Кирилл Вадимович", 1, 2, 3, "28%", "5%"],
			      "edit": []
			    },
			    {
			      "id": 665,
			    ...
			    {
			      "id": 776,
			      "cols": ["Умнобородов Михаил Александрович", 1, 2, 3, "28%", "5%"],
			      "edit": []
			    }
			  ]
			},
